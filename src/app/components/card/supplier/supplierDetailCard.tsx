    ...
    return (
        <div className="text-black">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mt-4">
                <Card title="Informasi Supplier" color="text-blue-500" className="bg-white">
                    <Item label="Nama" value={supplier.supplier_name ?? "-"} />
                    <Item label="No Telepon" value={supplier.phone_number ?? "-"} />
                </Card>

                <Card title="Alamat" color="text-yellow-500" className="bg-white">
                    <Item label="Kota" value={supplier.city ?? "-"} />
                </Card>

                <Card title="Tanggal Dibuat" color="text-green-500" className="bg-white">
                ...
                <Card title="Deskripsi" color="text-green-500" className="col-span-1 bg-white">
