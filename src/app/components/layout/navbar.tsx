...
export default function Navbar({ onToggleMenu , role }: Props) {
  ...
  return (
    <div className="flex flex-col h-full justify-between">
      <div>
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-[19px] border-b">
      ...
      <p className="text-black">
        <button 
          className="px-3 py-4 bg-red-500 hover:bg-red-600 text-white font-bold hover:cursor-pointer w-full"
